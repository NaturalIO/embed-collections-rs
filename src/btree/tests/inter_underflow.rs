...
fn test_inter_underflow_merge_right_height_3_2() {
    ...
    unsafe {
        ...
        cache.clear();
        let _ = map.root.find_leaf_with_cache(cache, &leaf_1_first);
...
fn test_inter_underflow_merge_left_height_3_2() {
    ...
    unsafe {
        ...
        let _ = map.root.find_leaf_with_cache(cache, leaf_3_lookup);
...
fn test_inter_underflow_merge_right_height_3() {
    ...
    unsafe {
        ...
        let cache = map.get_cache();
        cache.clear();
        let _ = map.root.find_leaf_with_cache(cache, &leaf_1.get_keys()[0]);
