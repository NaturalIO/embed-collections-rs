...
fn test_remove_range_api() {
    ...
    let last = map.remove_range((Bound::Excluded(5), Bound::Excluded(7)));
...
fn test_remove_range_large() {
    ...
    let last = map.remove_range(start as i32..end as i32);
